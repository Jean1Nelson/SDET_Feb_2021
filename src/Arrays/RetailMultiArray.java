...
public class RetailMultiArray
{
    ...
    //declaration of a multi-dimensional array
        ...
        double customer[][] = new double[20][2]; //20 customers, 2 values for each - invoice number, amount
        
        // {{10.0,1234.5}, {11.0,34535.6}}
    
    Scanner scan = new Scanner(System.in);
    
    System.out.println("Enter the elements of the array:");
    
    //one for loop for rows, one for columns
    for(int i=0;i<20;i++) //20 times from i=0 to i=19
    {
